...
Sequence("WelcomeandInstructions", "Consent", "ProlificID_trial", "Counter", randomize("Trials"), "LanguageQuestionnairePage", "Send", "FinalPage")
...
PennController("ProlificID_trial",   
    newText("Please fill in your Prolific ID again, so we can process your payment")
        .center()
        .print()
    ,
    newTextInput("ProlificID")
        ...
        .print()
    ,
    newButton("Continue to the survey")
        .center()
        .print()
        .wait()
    ,
