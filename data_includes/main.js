...
PennController.Template("trials.csv",
    row => newTrial("Trials", 
        ...
        newScale("Number", "One thing","More than one thing")
            ...
            .log()
        ,
        newScale("Imageability", "1","2","3","4","5")
        ...
        newScale("Sensibility", "1","2","3","4","5")
            ...
            .log()
        ,
        newCanvas("TrialCanvas", "100vw", "30vh")
            .add("center at 50vw", 0,    getText("Phrase"))
            .add("40vw", "10vh",   getScale("Number"))
            .add("40vw", "15vh",  getScale("Imageability"))
            .add("40vw", "20vh",  getScale("Sensibility"))
